...
int main()
{
    ...
    */
    ...
    cout << full_name.find("L") << endl;  //  0
    cout << full_name.find("l") << endl;  //  3
    cout << full_name.find("e") << endl;  //  1,5,11
    cout << full_name.find("ie") << endl;  // 4,5
    cout << full_name.find("e", 3) << endl;  //  5 
    ...
    cout << full_name.substr(4) << " is a substring of " << full_name << endl;  // 
